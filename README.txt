This folder contains the deliver of the SPM 2020/2021 Project of Andrea Zuppolini.
The project is: Cellular Automata framework.
#############################################################################################################################
The code is mostly ultimated and details about how to run it and the design choices will be provided in the report.

However, there are some short instruction to try the code.
